            ...
            [
              a(
                ...
                [
                  a(
                    'v-card',
                    { staticClass: 'pa-4', attrs: { align: 'center', outlined: '' } },
                    [
                      a(
                        'v-row',
                        { attrs: { align: 'center', justify: 'center' } },
                        [
                          a('v-col', { staticClass: 'pa-0', attrs: { cols: '5' } }, [
                            a(
                              'div',
                              { staticClass: 'display-1 text--primary' },
                              [
                                a('v-icon', { staticClass: 'pr-3', attrs: { color: 'primary' } }, [
                                  t._v(' mdi-account '),
                                ]),
                                t._v(' Log in '),
                              ],
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (e.next = 5),
                            i.a
                              .post(t.$store.getters.getBaseUrl + '/user/login', a)
                              .then(function (t) {
                                (s.loading = !1),
                                  (s.$store.state.user.email = s.email),
                                  s.$store
                                    .dispatch('setTokenForUser', { token: t.data })
                                    .then(function () {
                                      (s.$store.state.dialog2 = !1),
                                        (s.$store.state.loggedIn = !0),
                                        s.$axios
                                          .get('http://localhost:3000/getuserdetails', {
                                            params: { email: s.$store.state.user.email },
                                          })
                                          .then(function (t) {
                                            console.log(t.data),
                                              (s.$store.state.user = t.data),
                                              console.log(s.$store.state.user);
                                          })
                                          .catch(function () {
                                            console.log('ERROR');
                                          });
                              ...
                              .catch(function (t) {
                                (s.loading = !1),
                                  s.$store.commit('createSnackbar', { color: 'red', content: t });
                              })
                          );
                        case 5:
                        case 'end':
...
//# sourceMappingURL=chunk-2d225f64.81eb03e3.js.map
